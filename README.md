...
[Advanced Parallel Programming](https://github.com/csc-training/advanced-parallel-prog): exercise material and model answers for the CSC course "Advanced Parallel Programming". Other CSC courses are [Elements of high-performance computing](https://github.com/csc-training/elements-of-hpc), [Parallel Programming with MPI](https://github.com/csc-training/mpi-introduction), and [CSC Summer School in High-Performance Computing 2022](https://github.com/csc-training/summerschool).
