...
[geotiff-fortran](https://github.com/CNEA-AQ/geotiff-fortran): [GeoTIFF](https://en.wikipedia.org/wiki/GeoTIFF) reader module, from CNEA-AQ
...
[iRainSnowHydrov1.0](https://github.com/YuningLynn/iRainSnowHydrov1.0): distributed integrated rainfall-runoff and snowmelt-runoff simulation model for alpine watersheds, by Yuning Luo et al.
...
[PadeOps](https://github.com/Howland-Lab/PadeOps): ybrid OpenMP/MPI derivative operators using Compact Difference (6th and 10th Order) and Spectral (Fourier and Chebyshev) Methods to solve PDEs, from Howland-Lab
