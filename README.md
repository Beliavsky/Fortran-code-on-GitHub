...
[IBM_TENO](https://github.com/FallenCastle/IBM_TENO): GPU-accelerated solver for simulating supersonic flows using a combination of the Immersed Boundary Method (IBM) and Targeted Essentially Non-Oscillatory (TENO) schemes, by FallenCastle. It is designed to handle complex geometries efficiently on CUDA-enabled GPUs. Also [https://github.com/FallenCastle/MHD_GDDC_GPU](https://github.com/FallenCastle/MHD_GDDC_GPU), a GPU-accelerated code based on the TENO and Gradient Descent Divergence Cleaning method (GDDC) to solve the ideal magnetohydrodynamics equations.
