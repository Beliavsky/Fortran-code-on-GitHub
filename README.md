...
[AI-based Reconstruction of the Geospace Unified System (ARGUS)](https://github.com/grantkstephens/ARGUS): an associated paper is [Global Empirical Picture of Magnetospheric Substorms Inferred From Multimission Magnetometer Data](https://agupubs.onlinelibrary.wiley.com/doi/10.1029/2018JA025843), by G. K. Stephens et al., <i>JGR Space Physics</i> (2019)
...
[Gadgetviewer](https://github.com/jchelly/gadgetviewer): program for visualisation of [Gadget](https://wwwmpa.mpa-garching.mpg.de/gadget/) N-body simulation snapshots, by John Helly et al. It can read Gadget type 1, type 2 and HDF5 snapshots and provides an interactive display of the particle distribution, optionally with SPH type smoothing and colouring by any quantity that can be read from the snapshot.
...
[Planetary Atmosphere Chemistry and Temperature (PACT)](https://github.com/marcelinoagundez/pact): computes self-consistently the 1D vertical distribution of temperature (through radiative-convective equilibrium) and disequilibrium chemical composition (including thermochemical kinetics, photochemistry, and vertical mixing) in a planetary atmosphere. An associated paper is [The mutual influence of disequilibrium composition and temperature in exoplanet atmospheres](https://arxiv.org/abs/2506.11658), by Marcelino Agundez, <i>Astronomy & Astrophysics</i> (2025). Also [Atmospheric Chemical Equilibrium (ACE)](https://github.com/marcelinoagundez/ace), a code that computes the chemical equilibrium composition for a given elemental composition and pressure-temperature profile.
...
[Pulse_Profile_Simulation](https://github.com/edavurgun/Pulse_Profile_Simulation): code for a relativistic pulse profile simulation from a rotating neutron star with one or two hot spots on its surface, by Eda Vurgun, based on the paper [Hot spots on neutron stars - The near-field gravitational lens](https://ui.adsabs.harvard.edu/abs/1983ApJ...274..846P/abstract), by K. R. Pechenick et al., <i>Astrophysical Journal</i> (1983). Also [SPMHD](https://github.com/edavurgun/SPMHD) for numerical simulations with smoothed particle magnetohydrodynamics.
...
[Smallpox-in-Aboriginal-Australia](https://github.com/mcnitschke/Smallpox-in-Aboriginal-Australia): stochastic epidemiological models to test the origin and demographic impact of smallpox on Aboriginal Australians in the 18th Century, by Matthew Cody Nitschke and Corey Bradshaw
...
[dbrew-for](https://github.com/ivan-pi/dbrew-for): interfaces to the DBrew library for Dynamic Binary Rewriting by Ivan Pribec
...
[fcc_tools](https://github.com/jcerezochem/fcc_tools): tools by Javier Cerezo to facilitate input generation and analysis of [FCclasses](http://www.iccom.cnr.it/en/fcclasses/), a code that computes vibronic spectra and nonradiative rates based on the harmonic approximation
...
[unlimited_polymorphic_lists_f2008](https://github.com/paulovcmedeiros/unlimited_polymorphic_lists_f2008): doubly-linked lists for unlimited polymorphic objects, by Paulo V. C. Medeiros
...
[EulerFV](https://github.com/ackirby88/EulerFV): 2D unstructured finite volume Euler equation solver, by Andrew C. Kirby
...
[FortranVortexIdentify](https://github.com/RickXie43/FortranVortexIdentify): identifies discrete vortices from the velocity field data, using MPI, which are the result of a [DaVis PIV](https://www.lavision.de/en/products/davis-software/) process, by RickXie43
...
[Homogeneous Isotropic Turbulence in 3D (hit3d)](https://github.com/schumakov/hit3d): pseudo-spectral DNS code for simulation of homogeneous isotropic incompressible turbulence in three dimensional space, associated with the paper [Scaling properties of subgrid-scale energy dissipation](https://pubs.aip.org/aip/pof/article-abstract/19/5/058104/256754/Scaling-properties-of-subgrid-scale-energy), by Sergei G. Chumakov, <i>Physics of Fluids</i> (2007)
...
[IBM_TENO](https://github.com/FallenCastle/IBM_TENO): GPU-accelerated solver for simulating supersonic flows using a combination of the Immersed Boundary Method (IBM) and Targeted Essentially Non-Oscillatory (TENO) schemes, by FallenCastle. It is designed to handle complex geometries efficiently on CUDA-enabled GPUs. Also [MHD_GDDC_GPU](https://github.com/FallenCastle/MHD_GDDC_GPU), a GPU-accelerated code based on the TENO and Gradient Descent Divergence Cleaning method (GDDC) to solve the ideal magnetohydrodynamics equations.
...
[ISBN9784274224706-fortran](https://github.com/DSCF-1224/ISBN9784274224706-fortran): code from the book [Learning Computational Fluid Dynamics in Python](https://www.ohmsha.co.jp/book/9784274224706/) (2020) by Takazo Fujii and Tomoaki Tachikawa translated by DSCF-1224
...
[Lubrication-Dynamics-Biviscous](https://github.com/BCAM-CFD/Lubrication-Dynamics-Biviscous): code for suspensions in Newtonian and biviscous matrices with a lubrication dynamics model, associated with paper [Numerical investigation of the rheological behavior of a dense particle suspension in a biviscous matrix using a lubrication dynamics method](https://www.sciencedirect.com/science/article/abs/pii/S037702572030080X), by S.S. Prasanna Kumar et al., Journal of Non-Newtonian Fluid Mechanics (2020).
...
[MHIT36](https://github.com/MultiphaseFlowLab/MHIT36): code for direct numerical simulation of Navier-Stokes equation coupled with a phase-field method, Allen-Cahn Diffuse Interface (ACDI), for interface description, by Alessio Roccon et al. There is a multi-GPU version of MHIT36 using cuDecomp (Nvidia only).

[MovingEB_CNSAMReX](https://github.com/nataraj2/MovingEB_CNSAMReX): implementation of a moving embedded boundary algorithm for compressible flows within the compressible Navier-Stokes (CNS) framework in AMReX, by Mahesh Natarajan. Also [AxisymmetricJet](https://github.com/nataraj2/AxisymmetricJet), a flow solver for compressible, axisymmetric, cylindrical, nozzle jets.
...
[NCAR Turbulence with Lagrangian Particles (NTLP)](https://github.com/RichterLab/NTLP): simulates turbulent flows  using Lagrangian particle tracking to model complex fluid element trajectories, from RichterLab
...
[Polymer_DNS](https://github.com/ryankellybp11/Polymer_DNS): direct numerical simulation code for channel/boundary layer flows with an external force field, and optional passive scalar and polymer additives, by Ryan Kelly
...
[unified-bubble-theory](https://github.com/fslab-heu/unified-bubble-theory): code associated with paper [A unified theory for bubble dynamics](https://pubs.aip.org/aip/pof/article/35/3/033323/2882023/A-unified-theory-for-bubble-dynamics), by A-Man Zhang et al., Physics of Fluids (2023)
...
[3dVarBio](https://github.com/inogs/3dVarBio): variational method for data assimilation, associated with the paper [Parallel implementation of a data assimilation scheme for operational oceanography: The case of the MedBFM model system](https://www.sciencedirect.com/science/article/pii/S0098300418302334), by A. Teruzzi et al., <i>Computers & Geosciences</i> (2019)
...
[Atmospheric Lagrangian dispersion (ATLASFlor)](https://github.com/ATLASFlor/ATLAS-1.0): atmospheric dispersion model tailored to volcanic tephra/ash particles, by Reckziegel Florencia et al.
...
[cgfd-lab](https://github.com/dongli/cgfd-lab): demonstrations for teaching computational geophysical fluid dynamics, by dongli. Has code for classic or practical advection schemes: FTCS, Upwind, Beam-Warming, Lax-Wendroff, Fromm, Leap-frog, Crank-Nicolson, TSPAS, MPDATA, WENO, FFSL, Semi-Lagrangian.
...
[CVMix-src](https://github.com/CVMix/CVMix-src): robust and flexible library for parameterizing ocean vertical mixing processes, by Michael Levy et al.
...
[Ecosystem Demography Biosphere Model (ED2)](https://github.com/EDmodel/ED2): integrated terrestrial biosphere model incorporating hydrology, land-surface biophysics, vegetation dynamics, and soil carbon and nitrogen biogeochemistry
...
[EWSMod-2D](https://github.com/lanl/ews): code for modeling 2D elastic-wave sensitivity propagation and computing the spatial distribution of elastic-wave sensitivity energies in a heterogeneous model, which can be used for optimal design of time-lapse seismic monitoring surveys. A related book chapter is [Elastic-Wave Sensitivity Propagation for Optimal Time-Lapse Seismic Survey Design](https://agupubs.onlinelibrary.wiley.com/doi/10.1002/9781119156871.ch7), by Kai Gao et al., from the book [Geophysical Monitoring for Geologic Carbon Storage](https://agupubs.onlinelibrary.wiley.com/doi/book/10.1002/9781119156871) (2022).
...
[EXSIM](https://github.com/GFZ-Centre-for-Early-Warning/exsim): stochastic finite-fault program, as modified by Karen Assatourians and Gail Atkinson. Associated paper: [Stochastic Finite-Fault Modeling Based on a Dynamic Corner Frequency (2005)](https://pubs.geoscienceworld.org/ssa/bssa/article-abstract/95/3/995/103115/Stochastic-Finite-Fault-Modeling-Based-on-a),  Bulletin of the Seismological Society of America
...
[FEOTS](https://github.com/lanl/FEOTS): Fast Equilibration of Ocean Tracers, by Joe Schoonover et al.
...
[ForAdjoint](https://github.com/xumi1993/ForAdjoint): high-performance library for calculating adjoint sources in seismic waveform inversion, providing efficient implementations of various misfit functions and their corresponding adjoint sources, by Mijian Xu
...
[gravity-modelling-with-polynomial-density](https://github.com/Yonfou/gravity-modelling-with-polynomial-density): 3D Large-scale Gravitational Modelling Based on Tesseroids with a Polynomial Density of Arbitrary Degree in depth, by Fang Ouyang and Longwei Chen
...
[modaem](https://github.com/kelsonengineering/modaem): single-layer, steady-state analytic element groundwater flow model that has been enhanced for use with [GMS](https://aquaveo.com/software/gms/introduction), by Vic Kelson
...
[PLUMECALC](https://github.com/lanl/PLUMECALC): determines resident or flux-averaged concentrations in groundwater flow models using the results from a random-walk particle tracking model simulation, by Terry Miller
...
[QSSP](https://github.com/nicklinyi/qssp): complete synthetic seismograms for a spherical earth -- an all-in-one code for body waves, surface waves, free oscillations, tsunami for uniform ocean, infrasound waves for a standard atmosphere and static deformation, by Rongjiang Wang, modified by nicklinyi

[QSSPPEGS_2020](https://github.com/RongjiangWang/QSSPPEGS_2020): variant of the code [QSSP](https://github.com/nicklinyi/qssp) for calculating prompt elasto-gravity signals (PEGS) of an earthquake in a spherically symmetric and elastic earth. An associated paper is [Complete synthetic seismograms based on a spherical self-gravitating Earth model with an atmosphere–ocean–mantle–core structure](https://academic.oup.com/gji/article/210/3/1739/3868201), by Rongjiang Wang et al., <i>Geophysical Journal International</i> (2017). The author has several other seismology codes.
...
[rsofun](https://github.com/geco-bern/rsofun): R Simulating Optimal FUNctioning (RSOFUN) [framework](https://cran.r-project.org/web/packages/rsofun/index.html) with underlying Fortran code for site-scale simulations of ecosystem processes, with modules for the [P-model](https://gmd.copernicus.org/articles/13/1545/2020/), [SPLASH](https://gmd.copernicus.org/articles/10/689/2017/), and [BiomeE](https://bg.copernicus.org/articles/12/2655/2015/), from GECO
...
[SImulation COde for POLythermal Ice Sheets (SICOPOLIS)](https://github.com/sicopolis/sicopolis): 3D model that simulates the evolution, dynamics and thermodynamics of ice sheets and ice caps. An associated paper is [A continuum-mechanical formulation for shallow polythermal ice sheets](https://royalsocietypublishing.org/doi/10.1098/rsta.1997.0050), by R. Greve, <i>Philosophical Transactions of the Royal Society A</i> (1997).
...
[swatpgl](https://github.com/fuchsiger/swatpgl): SWAT+GL improves the applicability of SWAT+ in high-mountaineous & glaciated basins. An associated paper is [SWAT-GL: A New Glacier Routine For the Hydrological Model SWAT](https://onlinelibrary.wiley.com/doi/10.1111/1752-1688.13199), by Timo Schaffhauser et al., <i>Journal of the American Water Resources Association</i> (2024).
...
[FEM](https://github.com/viktorrobin/FEM): finite element modelling in Fortran for structural problems, solid mechanics, geotechnic and artificially structured soil, by Victor Robin
...
[rbf](https://github.com/nasa/rbf): mode shape interpolation via radial basis functions, by Steven J. Massey
...
[fortran_experiments](https://github.com/JorgeG94/fortran_experiments): simple progressive lessons on using CMake to build Fortran projects, by Jorge Luis Gálvez Vallejo
...
[Batteries Included Fortran Library (BiF-lib)](https://github.com/ScottBoyce/bif): modules for dates, dynamic arrays, error handling, I/O, parsing equations, statistics, prime numbers, random number generation, finding roots, sorting, strings, and data types such as `list` and `dict` that mimic Python, by Scott Boyce
...
[fuss](https://github.com/FortranGoingOnForty/fuss): interactive tree utility for quick staging dirty git files, by Matthew Forrester Wolffe. Also [fit](https://github.com/FortranGoingOnForty/fit), a terminal-based merge conflict resolver with a three-pane TUI interface.
...
[jflib](https://github.com/jabbalaci/jflib): utility library with assertions, constants, type conversions, string methods, a variable-length string type, and simpler command-line arguments, by Laszlo Szathmary
...
[sniffert](https://github.com/FortranGoingOnForty/sniffert): spacesniffer inspired Unix disk analyzer, by Matthew Forrester Wolffe
...
[Watch](https://github.com/Beliavsky/Watch): compute and display the CPU and wall time elapsed at break points in a program, by Beliavsky
...
[pkgfortran](https://github.com/albertopessia/pkgfortran): minimal R package for using Modern Fortran code in the backend, by Alberto Pessia
...
[EigenExa](https://github.com/RIKEN-RCCS/EigenExa): high-performance parallel eigenvalue solver, from the [RIKEN Center for Computational Science](https://www.r-ccs.riken.jp/en/), that works on many cutting-edge HPC platforms, including the [K Computer](https://www.riken.jp/en/collab/resources/kcomputer/)
...
[hello-sparse-blas](https://github.com/jfdev001/hello-sparse-blas): minimal sparse BLAS CMake project with Fortran and Intel MKL, demonstrating sparse matrix-vector multiplication, by Jared Frazier
...
[LRAP](https://github.com/sbudzinskiy/LRAP): subroutines for the constrained low-rank approximation of matrices and tensors: low-rank nonnegative matrix and tensor approximation, 
low-rank nonnegative matrix completion, and low-rank matrix and tensor approximation in the maximum norm, associated with paper [On the distance to low-rank matrices in the maximum norm.](https://www.sciencedirect.com/science/article/pii/S0024379524000570), by Stanislav Budzinskiy, Linear Algebra Appl (2024)
...
[sparseSET](https://github.com/dorivalpiedadeneto/sparseSET): library for assembling sparse matrices, by Dorival Piedade Neto et al.
...
[AMSimulator](https://github.com/Shahid718/AMSimulator): code associated with the paper [High performance additive manufacturing phase field simulation: Fortran Do Concurrent vs OpenMP](https://www.sciencedirect.com/science/article/abs/pii/S0927025625001314), by Shahid Maqbool and Byeong-Joo Lee, <i>Computational Materials Science</i> (2025)
...
[simulated_tem](https://github.com/mason-daniel/simulated_tem): compute simulated transmission electron microscope images in dynamical two beam condition. An associated paper is [Simulated TEM imaging of a heavily irradiated metal](https://www.sciencedirect.com/science/article/pii/S1359645424005135), by Daniel R. Mason et al., Acta Materialia (2024)
...
[libsupermesh](https://github.com/firedrakeproject/libsupermesh): library for serial and parallel mesh intersection, or supermeshing. An associated paper is [Conservative interpolation between volume meshes by local Galerkin projection](https://www.sciencedirect.com/science/article/abs/pii/S0045782510002276), by James R. Maddison and Patrick E. Farrell, Computer Methods in Applied Mechanics and Engineering (2011).
...
[overkit-fortran](https://github.com/majosm/overkit-fortran): overset grid assembly and remapping toolkit, by Matt Smith. Overset meshes are a method for representing complex geometry in computational fluid dynamics and other types of PDE-based simulations. There is a parallel C++ [version](https://github.com/majosm/overkit).
...
[smesh](https://github.com/trixi-framework/smesh): package for generating and handling unstructured triangular and polygonal meshes, by Simone Chiocchetti and Michael Schlottke-Lakemper
...
[TensorFlow to Fortran (tf2)](https://github.com/ivanZanardi/tf2): enables the integration of TensorFlow models into C++/Fortran projects seamlessly, without the need for TensorFlow installation or compilation, by Ivan Zanardi

[TorchFort](https://github.com/NVIDIA/TorchFort): deep learning training and inference interface from NVIDIA for HPC programs implemented using LibTorch, the C++ backend used by the PyTorch framework. This library can be invoked directly from Fortran or C/C++ programs.
...
[Burkardt-Fortran-90-codes](https://github.com/Beliavsky/Burkardt-Fortran-90-codes): codes for cluster analysis, combinatorics, computational geometry, eigenvalues, FFTs, graph algorithms, interpolation and approximation, dense and sparse linear algebra, nonlinear equations and nonlinear least squares, uniform and non-uniform random number generation, quasirandom number generation, optimization, probability distributions, numerical integration, root-finding, sorting, special functions, wavelet transforms, and other topics, by John Burkardt. Codes from his older site are [here](https://github.com/Beliavsky/Burkardt-Fortran-90-codes-SC).
...
[FORTRAN-ODE-Toolbox](https://github.com/bryand4140/FORTRAN-ODE-Toolbox): codes for solving linear and non-linear ordinary differential equations using the RK4, RK4 adaptive, and Dormand-Prince RK5 adaptive step methods, by Bryan Durham
...
[Parareal-Lorenz](https://github.com/KyFaxTeam/Parareal-Lorenz): implements both sequential RK4 and parallel Parareal solvers to efficiently simulate four dynamic regimes (non-walker, regular walker, chaotic walker, oscillations), from KyFaxTeam
...
[DFL](https://github.com/DerivativeFreeLibrary/DFL): Derivative-Free Linesearch algorithm for mixed-integer black-box problems by Giampaolo Liuzzi et al. Also [DDFSA](https://github.com/DerivativeFreeLibrary/DDFSA), a derivative-free simulated annealing global optimizer for bound constrained global optimization problems, [ACRS](https://github.com/DerivativeFreeLibrary/ACRS), A Controlled Random Search algorithm for bound constrained global optimization, [DIRDFN](https://github.com/DerivativeFreeLibrary/DIRDFN), derivative-free optimizer for constrained global nonlinear programming, [DIRMIN](https://github.com/DerivativeFreeLibrary/DIRMIN), A [DIRECT-based approach](https://link.springer.com/article/10.1007/s10898-020-00952-6) exploiting local minimizations for the solution of large-scale global optimization problems, [MODIR](https://github.com/DerivativeFreeLibrary/MODIR), derivative-free optimizer for inequality constrained multiobjective global optimization problems, [SDMINMAX](https://github.com/DerivativeFreeLibrary/SDMINMAX), Derivative-Free Algorithm for Linearly Constrained Finite Minimax Problems, [TESTGO](https://github.com/DerivativeFreeLibrary/TESTGO) which has bound constrained problems for global optimization, and [TESTMO](https://github.com/DerivativeFreeLibrary/TESTMO) which has multi-objective test problems

[dfo](https://github.com/jacobwilliams/dfo): package for solving general nonlinear optimization problems that have the following characteristics: they are relatively small scale (less than 100 variables) and their objective function is relatively expensive to compute and derivatives of such functions are not available, from COIN-OR
...
[fast_critical_line_algorithm](https://github.com/afniedermayer/fast_critical_line_algorithm): fast implementation of Markowitz's Critical Line Algorithm with bindings in Matlab and Python, by Andras Niedermayer
...
[lcmin](https://github.com/johngardenghi/lcmin): code by John L. Gardenghi associated with the paper [On the solution of linearly constrained optimization problems by means of barrier algorithms](https://link.springer.com/article/10.1007/s11750-020-00559-w), The Operations Research journal (2021). Also [ar4](https://github.com/johngardenghi/ar4) associated with the paper [On the use of third-order models with fourth-order regularization for unconstrained optimization](https://link.springer.com/article/10.1007/s11590-019-01395-z), Optimization Letters (2020), [mgh](https://github.com/johngardenghi/mgh), updated (from [Moré et al.](https://dl.acm.org/doi/pdf/10.1145/355934.355936)) Fortran routines for testing unconstrained optimization software with derivatives up to third-order, and [bglcovering](https://github.com/johngardenghi/bglcovering) associated with the paper "Asymptotic bounds on the optimal radius when covering a set with minimum radius identical balls", Mathematics of Operations Research (2024).
...
[Robust-Gauss-Newton-Algorithm](https://github.com/eachonly/Robust-Gauss-Newton-Algorithm): RGN algorithm introduces three heuristics to enhance its performance on nonlinear least squares problems: (i) the large sampling scale scheme to capture large-scale features of the objective function, (ii) the best-sampling point scheme to take advantage of free information, and (iii) the null-space jump scheme to escape near-flat regions. An associated paper is [A robust Gauss-Newton algorithm for the optimization of hydrological models: From standard Gauss-Newton to robust Gauss-Newton](https://agupubs.onlinelibrary.wiley.com/doi/10.1029/2017WR022488), by Youwei Qin et al., <i>Water Resources Research</i> (2018).
...
[ucminf](https://github.com/hdakpo/ucminf): R package by Hervé Dakpo with Fortran code originally by Robert Schnabel et al. for general-purpose unconstrained non-linear optimization. The algorithm is of quasi-Newton type with BFGS updating of the inverse Hessian and soft line search with a trust region type monitoring of the input to the line search algorithm. A Fortran 90 version of uncmin by John Burkardt is [here](https://people.math.sc.edu/Burkardt/f_src/nms/nms.html).

[vc-sqnm](https://github.com/moritzgubler/vc-sqnm): implements the vc-sqnm and stabilized quasi Newton method (SQNM) optimization algorithms in C++, Fortran and Python. The SQNM is a fast and reliable optimization method that is well adapted to find local minima on the potential energy surface. Associated preprint: [Efficient variable cell shape geometry optimization](https://arxiv.org/abs/2206.07339), by Moritz Gubler, Marco Krummenacher, Hannes Huber, and Stefan Goedecker.

[VTDIRECT95](https://github.com/vtopt/vtdirect95): implementation of D. R. Jones' deterministic global optimization algorithm called DIRECT, which is widely used in multidisciplinary engineering design, biological science, and physical science applications, by Layne T. Watson and Masha Sosonkina. The package includes both a serial code and a data-distributed massively parallel code for different problem scales and optimization (exploration vs. exploitation) goals.
...
[EZMPI](https://github.com/lguez/EZMPI): interface to the MPI library, at a higher level than the official interface, by Lionel Guez
...
[mpif](https://github.com/eschnett/mpif): provides Fortran bindings for MPI, given any C implementation of MPI, by Erik Schnetter
...
[N-Dimensional Solver Multrigrid (NDSM)](https://github.com/sag2021/ndsm): computes the potential (current-free) magnetic field on a rectilinear mesh in a Cartesian box, given the normal component of the magnetic field on each boundary face. An associated paper is [Relative Magnetic Helicity Based on a Periodic Potential Field](https://iopscience.iop.org/article/10.3847/1538-4357/ab8810), by Kai E. Yang et al., Astophysical Journal (2020).
...
[PadeOps](https://github.com/Howland-Lab/PadeOps): hybrid OpenMP/MPI derivative operators using Compact Difference (6th and 10th Order) and Spectral (Fourier and Chebyshev) Methods to solve PDEs, from Howland-Lab
...
[pyranda](https://github.com/LLNL/pyranda): finite difference solver with Python drivers for arbitrary hyperbolic PDE systems, by Britton Olson. The PDE solver defaults to a 10th order compact finite difference method for spatial derivatives, and a 5-stage, 4th order Runge-Kutta scheme for temporal integration.
...
[Surfaces](https://github.com/JamesCBremerJr/Surfaces): Code for discretizing certain singular integral operators given on surfaces, including single and double layer potentials, associated with paper [A Nyström method for weakly singular integral operators on surfaces](https://www.sciencedirect.com/science/article/pii/S002199911200174X), by James Bremer and Zydrunas Gimbutas, Journal of Computational Physics Volume 231, Issue 14, 20 May 2012, Pages 4885-4903
...
[disorder](https://github.com/alexanderkarlberg/disorder): program for computing differential cross sections in massless deep inelastic scattering, by Alexander Karlberg
...
[Gyrokinetic Advanced Collision Moment Solver (gyacomo)](https://github.com/Antoinehoff/gyacomo): MPI code that solves the nonlinear gyrokinetic Boltzmann equation in the delta-f flux-tube limit with a moment-based approach derived from a Hermite-Laguerre velocity space representation. An associated paper is [Gyrokinetic moment-based simulations of the Dimits shift](https://www.cambridge.org/core/journals/journal-of-plasma-physics/article/gyrokinetic-momentbased-simulations-of-the-dimits-shift/8413B588DBE2DAAF5C8AD9D6EE1A1FB1), by A.C.D. Hoffmann et al., <i>Journal of Plasma Physics</i> (2023).

[HYPIC](https://github.com/DrMYWu/HYPIC): code associated with paper [HYPIC: A fast hybrid EM PIC-MCC code for ion cyclotron resonance energization in cylindrical coordinate system](https://www.sciencedirect.com/science/article/abs/pii/S0010465524001309), by Mingyang Wu et al., <i>Computer Physics Communications</i> (2024)
...
[KORC](https://github.com/ORNL-Fusion/KORC): Kinetic Orbit Runaway Code, from ORNL-Fusion. [PARVMEC](https://github.com/ORNL-Fusion/PARVMEC) is a 3D Equilibrium solver with nested flux surfaces, [LIBSTELL](https://github.com/ORNL-Fusion/LIBSTELL) is the main stellarator resource library, [DIV3D](https://github.com/ORNL-Fusion/DIV3D) is a field line followning and intersection code, [BOOZ_XFORM](https://github.com/ORNL-Fusion/BOOZ_XFORM) converts VMEC coordinates to Boozer coordinates, [MAKEGRID](https://github.com/ORNL-Fusion/MAKEGRID) precomputes vacuum fields, [V3RFUN](https://github.com/ORNL-Fusion/V3RFUN) computes magnetic diagnostic response functions, [SURFACE](https://github.com/ORNL-Fusion/SURFACE) computes vector potential at wall structures, and [DESCUR](https://github.com/ORNL-Fusion/DESCUR) uses a steepest descent algorithm to find a least squares approximation to an arbitrary 3-d space curve. [BMW](https://github.com/ORNL-Fusion/BMW) is a code for extending fields belond the VMEC domain in a manner that ensures divergence free fields. BMW does a Biot-Savart volume integration of of the equilibrium current density to obtain a continous vector potential everywhere on the mgrid grid. [PoinBabel](https://github.com/ORNL-Fusion/PoinBabel) generates Poincare sections using KORC methods and different field interpolation options. [Stellgap](https://github.com/ORNL-Fusion/Stellgap) calculates the shear Alfven gap structure for 3D configurations (stellarators, RFPs, 3D tokamaks). [AE3D](https://github.com/ORNL-Fusion/AE3D) calculates shear Alfven eigenmodes for 3D configurations (stellarators, RFPs, 3D tokamaks). [PENTA](https://github.com/ORNL-Fusion/PENTA) calculates the neoclassical parallel flows, radial particle and energy fluxes, and the radial electric field for a surface given the plasma profiles (n, T), surface geometry information (from VMEC) and the monoenergetic transport coefficients (from DKES). [p2f](https://github.com/ORNL-Fusion/p2f) computes a particle to distribution function.
...
[codyfortran](https://github.com/flackner/codyfortran): framework for simulating interacting quantum many-body systems, by Fabian Lackner. Designed to be flexible and versatile, it enables advanced simulations of fermionic, bosonic, and mixed quantum systems with customizable potential and interaction functions.
...
[fractal_optics_coreshell](https://github.com/storyofthewolf/fractal_optics_coreshell): code associated with the paper [Mean-field approximation of Mie scattering by fractal aggregates of identical spheres](https://opg.optica.org/ao/abstract.cfm?uri=ao-36-33-8791), by Robert Botet et al., <i>Applied Optics</i> (1997), modernized by Eric T. Wolf
...
[FuzzifiED_Fortran](https://github.com/FuzzifiED/FuzzifiED_Fortran): Fortran code in the Julia package [FuzzifiED](https://github.com/mankai-chow/FuzzifiED.jl) intended for exact diagonalisation (ED) calculations on fuzzy sphere, by Zheng Zhou et al.
...
[Maxwell Construction Solver](https://github.com/sorush-khajepor/MaxwellConstruction): finds the saturation pressure, vapor and liquid density at a saturation temperature (Tsat) for Van der Waals (VW), Peng-Robinson (PR), Redlich-Kwong (RK), Soave-Redlich-Kwong (SRK), Carnahan-Starling (CS). Associated paper: [Multipseudopotential interaction: A consistent study of cubic equations of state in lattice Boltzmann models](https://journals.aps.org/pre/abstract/10.1103/PhysRevE.93.013303), by S. Khajepor and B. Chen, Physical Review E 93 (1), 013303 (2016)

[MC_GPU](https://github.com/evanoya/MC_GPU): GPU parallel Monte Carlo code for patchy particles with the model potential described in the paper [Programming patchy particles to form complex periodic structures](https://pubs.aip.org/aip/jcp/article-abstract/151/22/224506/198556/Programming-patchy-particles-to-form-complex), by D. Tracey et al., <i>The Journal of Chemical Physics</i> (2019)
...
[Numerical Reactive Gas-dynamics (NRG)](https://github.com/yakovenko-ivan/NRG): by Ivan Yakovenko

[Numerov](https://github.com/kuwahatakazuaki/Numerov): program that creates a wave function from a one-dimensional potential using the Numerov method, by kuwahatakazuaki
...
[SB](https://github.com/Dmitry-Skachkov/SB): code associated with paper [First-principles theory for Schottky barrier physics](https://journals.aps.org/prb/abstract/10.1103/PhysRevB.104.045429), by Dmitry Skachkov et al., <i>Physical Review B</i> (2021)
...
[sparse-ir-fortran](https://github.com/SpM-lab/sparse-ir-fortran): interface for sparse-ir, a library providing routines for constructing and working with the intermediate representation of correlation functions, by Hitoshi Mori et al.
...
[BDD](https://github.com/schuurman-group/BDD): tools for the construction of vibronic coupling Hamiltonians using block diagonalisation diabatisation, by
schuurman-group. Also [General Reference Configuration Interaction package (GRACI)](https://github.com/schuurman-group/graci), [chebytools](https://github.com/schuurman-group/chebytools) for spectrum simulation using Chebyshev order-domain autocorrelation functions, and [csf2det](https://github.com/schuurman-group/csf2det), a program to convert configuration interaction (CI) wavefunctions in configuration state function (CSF) to determinant basis.
...
[Electronic Structure to k(T,P) (EStokTP)](https://github.com/EStokTP/EStokTP): generates rate constants relying on calls to external codes to perform electronic structure calculations and master equation simulations, by Carlo Cavallotti et al.
...
[pseudopotential](https://github.com/jlm785/pseudopotential): modernized atomic configuration and pseudopotential generation code, associated with the paper [Efficient pseudopotentials for plane-wave calculations](https://journals.aps.org/prb/abstract/10.1103/PhysRevB.43.1993), by Norm Troullier and José Luís Martins, <i>Physical Review B</i> (1991). Also [cpw2000](https://github.com/jlm785/cpw2000), a density functional theory pseudopotential plane-wave code.
...
[dSFMT_F03_interface](https://github.com/jsspencer/dSFMT_F03_interface): interface by James Spencer to [dSFMT](https://github.com/MersenneTwister-Lab/dSFMT) (double precision SIMD-oriented Fast Mersenne Twister) pseudo-random number generator by Mutsuo Saito and Makoto Matsumoto
...
[melg-64-fortran](https://github.com/DSCF-1224/melg-64-fortran): code by DSCF_1224 for the algorithm of the paper [Implementing 64-bit maximally equidistributed F2-linear generators with Mersenne prime period](https://dl.acm.org/doi/10.1145/3159444), by Shin Harase and Takamitsu Kimoto, <i>ACM Transactions on Mathematical Software</i> (2018)
...
[Simple Neutron-Transport Equation Solver (SNES)](https://github.com/msleigh/snes): 1D discrete-ordinates neutron transport code, with diamond-difference and linear-discontinuous variants, by Michael Sleigh
...
[wvdecomp](https://github.com/avikhlinin/wvdecomp): wavelet decomposition algorithm, by Alexey Vikhlinin. A write-up describes its use to restore images with Gaussian or Poisson noise.
...
[utf8f](https://github.com/yymmt742/utf8f): set of functions useful for handling utf-8 strings, such as `len`, `codepoint`, `width`, `category`, and `easta_property`, by yymmt742
...
[urca](https://github.com/cran/urca): R package with Fortran subroutines to estimate critical values and P values for unit root and cointegration tests, by James G. MacKinnon
