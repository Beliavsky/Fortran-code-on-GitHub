...
[AMSimulator](https://github.com/Shahid718/AMSimulator): compares Do Concurrent with OpenMP's performance for additive manufacturing using the phase field approach, associated with the paper [High performance additive manufacturing phase field simulation: Fortran Do Concurrent vs OpenMP](https://www.sciencedirect.com/science/article/abs/pii/S0927025625001314), by Shahid Maqbool and Byeong-Joo Lee, <i>Computational Materials Science</i> (2025)
